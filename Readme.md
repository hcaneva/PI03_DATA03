...
El mismo deberá contar además con el volumen de transacción y valor de media móvil.<br>
...
El archivo adjunto "PI03-DATA03.pbix" es una presentacion interactiva que cuenta con una introduccion al tema, el dashboard, la calculadora y el reporte de calidad de los datos.<br>
Se puede navegar a travez de los botones de navegacion o bien de hoja en hoja.
